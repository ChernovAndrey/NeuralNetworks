...
\usepackage{hyperref}
\usepackage[footnotes,oglav,spisok,boldsect,kursrab,remarks,greekup]{project}
...
$$
m_{0_0} = 3.9753 \quad m_{0_1} = 3.9817  \quad
var_{0_0} = 146.9832 \quad var_{0_1} = 147.5937  
$$

$$
m_{1_0} = 6.0533 \quad m_{1_1} = 6.0630  \quad
