...
def get_kept_filters(model,count_filters,input_img_width,input_img_height,input_count_filters):
...
if __name__ == "__main__":   
    model  = get_model('/home/andrey/datasetsNN/landScapes/landScape_3000_32/model_AlexNet_fullConv_30_07_2018.hdf5')
    count_2d_conv = 3
    ...
    path_save = 'cnn_visualization_pictures/31_07_2018/'
    for i in range(count_2d_conv):
